 ...
 *       &lt;sequence>
 *         &lt;element ref="{}ScilabString" maxOccurs="unbounded" minOccurs="0"/>
...
public class TextBlock {
    ...
    @XmlElement(name = "ScilabString")
    protected List<ScilabString> scilabString;
    @XmlElements({
     ...
     * This is why there is not a <CODE>set</CODE> method for the scilabString property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getScilabString().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ScilabString> getScilabString() {
        if (scilabString == null) {
            scilabString = new ArrayList<ScilabString>();
        }
        return this.scilabString;
    }
