 ...
 *       &lt;sequence>
 *         &lt;element ref="{}SuperBlockDiagram" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "SuperBlock")
public class SuperBlock {

    @XmlElement(name = "SuperBlockDiagram")
    protected List<SuperBlockDiagram> superBlockDiagram;
    @XmlElements({
    ...
    /**
     * Gets the value of the superBlockDiagram property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the superBlockDiagram property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSuperBlockDiagram().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SuperBlockDiagram }
     * 
     * 
     */
    public List<SuperBlockDiagram> getSuperBlockDiagram() {
        if (superBlockDiagram == null) {
            superBlockDiagram = new ArrayList<SuperBlockDiagram>();
        }
        return this.superBlockDiagram;
    }
